...
| **11:00** | **Break** | | |
| **11:30** | *Introduction to command line interface* | [Notes](https://github.com/Arash-Iranzadeh/Microbial-Genomics/blob/main/docs/0_unix_command_line.pptx) [Practical](https://github.com/Arash-Iranzadeh/Microbial-Genomics/blob/main/scripts/0_practice_unix_commands.sh) | Arash Iranzadeh |
...
| Time (CAT) | Topic | Links | Trainer |
|------------|-------|-------|---------|
| **09:00** | *Introduction to command line interface* | [Notes](https://github.com/Arash-Iranzadeh/Microbial-Genomics/blob/main/docs/0_unix_command_line.pptx) [Practical](https://github.com/Arash-Iranzadeh/Microbial-Genomics/blob/main/scripts/0_practice_unix_commands.sh) | Arash Iranzadeh |
